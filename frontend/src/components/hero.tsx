    ...
    <section className="relative overflow-hidden bg-background py-20 sm:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
            ...
            className="relative"
        >
            <div className="relative aspect-square overflow-hidden rounded-2xl bg-gradient-to-br from-teal-500/20 to-purple-600/20 p-8">
              ...
              <div className="relative h-full w-full rounded-xl bg-background/80 backdrop-blur-sm flex items-center justify-center">
                <img src="/logo.png" alt="Jnana Setu Logo" className="max-w-[90%] max-h-[90%] object-contain" style={{ display: 'block' }} />
              </div>
          </div>
        </motion.div>
        </div>
